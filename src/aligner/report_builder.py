...
class HTMLReportBuilder:
    ...
    def _get_plotly_optimization_landscape(self, slice_landscape):
        ...
        fig.update_layout(autosize=True, height=350, plot_bgcolor='white', margin=dict(t=30, b=30, l=30, r=30), showlegend=True)
        return fig
    ...
    def build_report(self, report_package, output_path="alignment_explorer.html"):
        ...
        # Safely find the winning tournament outcome to grab the exact confidence and cell count
